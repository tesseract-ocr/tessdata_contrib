...
#   of the filename, e.g. hoc_v1_2.341_4500_18200.checkpoint → 2.341%).
...
#
# Output:
#   output/hoc_v1.traineddata
#
# To install:
#   cp output/hoc_v1.traineddata /opt/homebrew/share/tessdata/
#   tesseract myimage.tif result -l hoc_v1
# ═══════════════════════════════════════════════════════════════
set -e
...
# Bundle into traineddata (start from hoc_base — preserves Ho unicharset)
cp "$TESSDATA_BEST/hoc_base.traineddata" "$OUTPUT/${MODEL_NAME}.traineddata"
combine_tessdata \
